...
set ::env(CARRY_SELECT_ADDER_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/csa_map.v}
set ::env(CELLS_LEF) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lef/sky130_ef_sc_hd.lef /tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef}
set ::env(CELLS_LEF_OPT) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lef/sky130_ef_sc_hd.lef /tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef}
...
set ::env(CVC_SCRIPTS_DIR) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/cvc}
...
set ::env(DRC_EXCLUDE_CELL_LIST) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRC_EXCLUDE_CELL_LIST_OPT) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
...
set ::env(FULL_ADDER_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/fa_map.v}
set ::env(GDS_FILES) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/gds/sky130_fd_sc_hd.gds}
set ::env(GDS_FILES_OPT) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/gds/sky130_fd_sc_hd.gds}
...
set ::env(GPIO_PADS_LEF) { /tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_io/lef/sky130_fd_io.lef /tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_io/lef/sky130_ef_io.lef }
set ::env(GPIO_PADS_LEF_CORE_SIDE) { /tools/pdks/share/pdk/sky130B/libs.tech/openlane/custom_cells/lef/sky130_fd_io_core.lef /tools/pdks/share/pdk/sky130B/libs.tech/openlane/custom_cells/lef/sky130_ef_io_core.lef }
set ::env(GPIO_PADS_VERILOG) {/tools/pdks/share/pdk/sky130B/libs.ref/verilog/sky130_fd_io/sky130_ef_io.v}
...
set ::env(KLAYOUT_DRC_TECH_SCRIPT) {/tools/pdks/share/pdk/sky130B/libs.tech/klayout/drc/sky130B_mr.drc}
set ::env(KLAYOUT_PROPERTIES) {/tools/pdks/share/pdk/sky130B/libs.tech/klayout/tech/sky130B.lyp}
set ::env(KLAYOUT_TECH) {/tools/pdks/share/pdk/sky130B/libs.tech/klayout/tech/sky130B.lyt}
set ::env(KLAYOUT_XOR_GDS) {1}
set ::env(KLAYOUT_XOR_XML) {1}
set ::env(LEC_ENABLE) {0}
set ::env(LEFT_MARGIN_MULT) {12}
set ::env(LIB_FASTEST) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_SLOWEST) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_TYPICAL) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
...
set ::env(MAGIC_MAGICRC) {/tools/pdks/share/pdk/sky130B/libs.tech/magic/sky130B.magicrc}
set ::env(MAGIC_PAD) {0}
set ::env(MAGIC_TECH_FILE) {/tools/pdks/share/pdk/sky130B/libs.tech/magic/sky130B.tech}
set ::env(MAGIC_WRITE_FULL_LEF) {0}
set ::env(MAGIC_ZEROIZE_ORIGIN) {0}
set ::env(NETGEN_SETUP_FILE) {/tools/pdks/share/pdk/sky130B/libs.tech/netgen/sky130B_setup.tcl}
set ::env(NO_SYNTH_CELL_LIST) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/no_synth.cells}
set ::env(OPENLANE_VERBOSE) {0}
set ::env(PDKPATH) {/tools/pdks/share/pdk/sky130B}
...
set ::env(PL_LIB) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
...
set ::env(RCX_RULES) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/rules.openrcx.sky130B.nom.spef_extractor}
set ::env(RCX_RULES_MAX) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/rules.openrcx.sky130B.max.spef_extractor}
set ::env(RCX_RULES_MIN) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/rules.openrcx.sky130B.min.spef_extractor}
...
set ::env(RIPPLE_CARRY_ADDER_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/rca_map.v}
...
set ::env(START_TIME) {2023.02.17_14.49.48}
set ::env(STA_REPORT_POWER) {1}
set ::env(STD_CELL_GROUND_PINS) {VGND VNB}
set ::env(STD_CELL_LIBRARY) {sky130_fd_sc_hd}
set ::env(STD_CELL_LIBRARY_CDL) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/cdl/sky130_fd_sc_hd.cdl}
set ::env(STD_CELL_LIBRARY_OPT) {sky130_fd_sc_hd}
set ::env(STD_CELL_LIBRARY_OPT_CDL) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/cdl/sky130_fd_sc_hd.cdl}
...
set ::env(SYNTH_LATCH_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/latch_map.v}
set ::env(SYNTH_MAX_FANOUT) {10}
set ::env(SYNTH_MIN_BUF_PORT) {sky130_fd_sc_hd__buf_2 A X}
set ::env(SYNTH_MUX4_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/mux4_map.v}
set ::env(SYNTH_MUX_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/mux2_map.v}
...
set ::env(TECH_LEF) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef}
set ::env(TECH_LEF_MAX) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__max.tlef}
set ::env(TECH_LEF_MIN) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__min.tlef}
set ::env(TECH_LEF_OPT) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef}
set ::env(TERMINAL_OUTPUT) {/dev/null}
set ::env(TMP_DIR) {/openlane/designs/ram_example/runs/openlane_test/tmp}
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRISTATE_BUFFER_MAP) {/tools/pdks/share/pdk/sky130B/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
...
set ::env(CURRENT_DEF) /openlane/designs/ram_example/runs/openlane_test/tmp/routing/18-fill.def
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_INDEX) 19
set ::env(CURRENT_NETLIST) /openlane/designs/ram_example/runs/openlane_test/results/cts/ram_example.resized.v
set ::env(PREV_NETLIST) /openlane/designs/ram_example/runs/openlane_test/results/placement/ram_example.resized.v
set ::env(PDK_ROOT) {/tools/pdks/share/pdk}
set ::env(BASE_SDC_FILE) {/openlane/designs/ram_example/base.sdc}
...
set ::env(INPUT_DEF) {/openlane/designs/ram_example/runs/openlane_test/tmp/cts/13-resizer_timing.def}
set ::env(IO_PCT) {0.2}
set ::env(KLAYOUT_DRC_KLAYOUT_GDS) {0}
set ::env(KLAYOUT_DRC_TECH_SCRIPT) {/tools/pdks/share/pdk/sky130B/libs.tech/klayout/drc/sky130B_mr.drc}
set ::env(KLAYOUT_PROPERTIES) {/tools/pdks/share/pdk/sky130B/libs.tech/klayout/tech/sky130B.lyp}
...
set ::env(LAST_TIMING_REPORT_TAG) {/openlane/designs/ram_example/runs/openlane_test/reports/synthesis/2-syn_sta}
...
set ::env(LIB_SYNTH_COMPLETE) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/openlane/designs/ram_example/runs/openlane_test/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/openlane/designs/ram_example/runs/openlane_test/tmp/synthesis/merged.lib}
set ::env(LIB_SYNTH_NO_PG) {/openlane/designs/ram_example/runs/openlane_test/tmp/synthesis/1-trimmed.no_pg.lib}
set ::env(LIB_TYPICAL) {/tools/pdks/share/pdk/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/openlane/designs/ram_example/runs/openlane_test/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_INSERT_POWER_PINS) {1}
...
set ::env(RUN_TAG) {openlane_test}
set ::env(SAVE_DEF) {/openlane/designs/ram_example/runs/openlane_test/tmp/routing/19-global.def}
set ::env(SAVE_GUIDE) {/openlane/designs/ram_example/runs/openlane_test/tmp/routing/19-global.guide}
set ::env(SAVE_NETLIST) {/openlane/designs/ram_example/runs/openlane_test/results/cts/ram_example.resized.v}
...
set ::env(signoff_results) {/openlane/designs/ram_example/runs/openlane_test/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/ram_example/runs/openlane_test/tmp/signoff}
set ::env(synth_report_prefix) {/openlane/designs/ram_example/runs/openlane_test/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/openlane/designs/ram_example/runs/openlane_test/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/ram_example/runs/openlane_test/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/ram_example/runs/openlane_test/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/ram_example/runs/openlane_test/tmp/synthesis}
set ::env(timer_start) {1676645388}
set ::env(PDK_ROOT) {/tools/pdks/share/pdk}
set ::env(BASE_SDC_FILE) {/openlane/designs/ram_example/base.sdc}
set ::env(BASIC_PREP_COMPLETE) {1}
set ::env(BOTTOM_MARGIN_MULT) {4}
